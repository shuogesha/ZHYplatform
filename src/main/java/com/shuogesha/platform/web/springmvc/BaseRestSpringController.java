package com.shuogesha.platform.web.springmvc;
...
import com.shuogesha.platform.web.util.ConvertRegisterHelper;
import com.shuogesha.platform.web.util.PageRequestFactory;
 ...
 * <pre>
 * /entity                => index()  
 * /entity/new            => _new()  注意: 不使用/userinfo/add => add()的原因是ad会被一些浏览器当做广告URL拦截
 * /entity/{id}           => show()  
 * /entity/{id}/edit      => edit()  
 * /entity        POST    => create()  
 * /entity/{id}   PUT     => update()  
 * /entity/{id}   DELETE  => delete()  
 * /entity        DELETE  => batchDelete()  
 * </pre>
 * 
 * @author badqiu
 */
