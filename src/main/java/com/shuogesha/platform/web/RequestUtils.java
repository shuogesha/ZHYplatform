...
import static com.shuogesha.platform.Constants.POST;
import static com.shuogesha.platform.Constants.UTF8;
...
public class RequestUtils {
	...
	private static SimpleDateFormat format = new SimpleDateFormat(Constants.DATEFORMAT);
