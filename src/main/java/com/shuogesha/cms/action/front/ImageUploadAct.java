...
import com.shuogesha.platform.service.DbFileService;
...
public class ImageUploadAct {
	...
	@RequestMapping(value = "/file/webuploader_image_Up.jhtml", method = RequestMethod.POST)
	public void webuploader(@RequestParam(required = false) MultipartFile file,
