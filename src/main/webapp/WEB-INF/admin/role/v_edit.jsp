	...
	<form id="jvForm"  action="o_update.do" method="post"  class="form form-horizontal" enctype="multipart/form-data">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bean.name}" placeholder="" id="name" name="name" datatype="*4-16" nullmsg="角色名称不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">备注：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bean.description}" placeholder="拥有至高无上的权限" id="description" name="description">
			</div>
		</div>
		<div class="row cl">
